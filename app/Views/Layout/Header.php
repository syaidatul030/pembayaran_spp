...
<head>
  ...
  <meta name="author" content="SyaidMusa">
...
<body class="d-flex flex-column h-100">
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-info">
      <a class="navbar-brand" href="/petugas/dashboard"> <b>AplikasiSPP</b>
    </a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <?php if (session()->get('level') == 'admin') { ?>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                <i class="fas fa-envelope-open-text"></i> Master Data
              </a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="/petugas/logout" data-confirm="Anda yakin akan mengakhiri ?"><i class="fa fa-caret-right"></i> Logout</a>
          </li>
